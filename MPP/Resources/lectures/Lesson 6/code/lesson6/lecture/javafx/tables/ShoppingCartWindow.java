...
public class ShoppingCartWindow extends Stage {
	...
	public ShoppingCartWindow() {
		...
		//   ((ShoppingCart) t.getTableView().getItems().get(t.getTablePosition().getRow()))
        //        .setQuantity(t.getNewValue()));
				
				/*
	            new EventHandler<CellEditEvent<ShoppingCart, String>>() {
	                @Override
	                public void handle(CellEditEvent<ShoppingCart, String> t) {
	                    ((ShoppingCart) t.getTableView().getItems().get(
